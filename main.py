...
etage_sup=classes.Button(1042, 617, 40, 40, "↑",font=pygame.font.Font("assets/DejaVuSans.ttf", 15))
etage_inf=classes.Button(1042, 617+40, 40, 40, "↓",font=pygame.font.Font("assets/DejaVuSans.ttf", 15))
ui=classes.Button(1529,236, 340, 100,text="",font=pygame.font.Font("assets/DejaVuSans.ttf", 15))
bouton_mode_long = classes.Button(screen.get_width() // 2 - 160, screen.get_height() // 2 - 20, 320, 50, "Itinéraire le plus long", font=pygame.font.Font("assets/DejaVuSans.ttf", 25))
...
while running:
    ...
    if etat == "itinéraire":
        ...
        if menu_deroulant.action==True:
            ...
            if mode_long:
                _,chemins = algo_long.gps_long(classes.départ_salle, classes.arrivée_salle, tmx_data, tmx_data_b, tmx_data_d, tmx_data_c, layers_2, layers_3, layers_1, layers_cdi)
            else:
    ...
    if options_ouvert:
        ...
        screen.blit(texte, (screen.get_width()//2 - 80, screen.get_height()//2 - 300))
        bouton_mode_long.color = (150, 255, 150) if mode_long else (240, 240, 240)
